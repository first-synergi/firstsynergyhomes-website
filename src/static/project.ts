export const ProjectDetails = {
  projects: [
    {
      id: "mulberry-mansions-development",
      projectName: "Mulberry Mansions Development",
      status: "Completed",
      summary: `<p>Scope - Build Only (civil works and finishes generally)</p>
<p>Building Type - Residential Development.</p>
<p>Project Configuration - 2 Blocks of Ground</p>
<p>+ 3 Upper floors. (Comprising of 3, 4 and 4 bedrooms</p>
<p>of Maisonettes, Terraces, Penthouse and<br/>
...
`,
    ...
    {
      id: "r-jolad-hospital",
      projectName: "R-Jolad Plus Hospital",
      status: "Completed",
      summary: `<p>Scope - Build Only (civil works and finishes generally)</p>
...
`,
    ...
    },
    {
      ...
      projectName: "ProvidusBank Branch Development",
      status: "Completed",
      summary: `<p>Scope - Design and Build<br/>
Status - Completed Q1 2024.<br/>
Building Type - Commercial Development<br/>
...
`,
    ...
    {
      id: "northwest-filling-station-maryland",
      projectName: "NorthWest Filling Station Sales Building",
      status: "Completed",
      summary: `<p>Scope - Design & Build
</p>`,
    ...
    {
      id: "residential-villa-325-close",
      projectName: "Residential Villas, Plot E13, 325 Close",
      status: "Completed",
    ...
    {
      id: "country-house-villa",
      projectName: "Countryhouse Villa",
      status: "Completed",
      summary: `<p>Scope - Build Only</p>`,
    ...
    {
      id: "providus-bank-head-office",
      projectName: "ProvidusBanK Head Office",
      status: "Completed",
...
`,
    ...
    },
    {
      ...
      projectName: "Providus Bank Branch",
      status: "Completed",
      summary: `<p>Scope - Design and Build<br/>
Building Type - Commercial Development.<br/>
...
`,
    ...
    {
      id: "northwest-filling-station-vgc",
      projectName: "NorthWest Filling Station by VGC Estate",
      status: "Completed",
      summary: ``,
    ...
    {
      id: "castle-and-temple-road-residential",
      projectName: "Residential Development at Castle and Temple Road",
      status: "Completed",
      summary: `<p>Scope - Design and Build<br/>
Building Type - Residential Development.<br/>
Project Configuration - 3 Units of Ground + 3 Upper floors.<br/>
(Comprising of 4 - 5 bedrooms of Detached Duplex<br/>
respectively)</p>
`,
    ...
    {
      id: "providus-bank-regional-office",
      projectName: "ProvidusBank Regional Office",
      status: "Completed",
      summary: `<p>ProvidusBank Regional Office. Adetokunbo Ademola Avenue, Wuse<br/> Zone II, Abuja
</p>
`,
    ...
    {
      id: "northwest-filling-station-gbagada",
      projectName: "NorthWest Filling Station Sales Building",
      status: "Completed",
      summary: `<p>Scope - Design & Build
</p>`,
    ...
    {
      id: "2-units-semi-detached-duplex-lekkki",
      projectName: "2 Units of 5 Bedroom Semi Detached Duplex",
      status: "Completed",
      summary: "",
    ...
    {
      id: "5-bedroom-detached-duplex",
      projectName: "5 Bedroom Detached Duplex",
      status: "Completed",
      summary: "",
      location: "Lekki Scheme 1, Lagos State",
      completionYear: "2013",
    ...
    {
      id: "villa-cameron-rd",
      projectName: "Villa at Cameron Road",
      status: "Completed",
      summary: `<p>Scope - Design and Build</p>`,
...
Project Configuration - Ground + 2 Upper floors.
    ...
    },
    {
      ...
      projectName: "Cullingham Place",
      status: "Ongoing",
      summary: `<p>Scope - Design and Build<br/>
Building Type - Private Residential Developments.<br/>
Project Configuration - 96 units of a combination of Detached, Semi-<br/>detached, Terraces, 2-3 bedroom apartments and Penthouses.
</p>`,
    ...
    },
    {
      ...
      summary: `<p>Scope - Design and Build<br/>
Building Type - Private Residential Development.<br/>
Project Configuration - Ground + 7 floors of 4-5 bedroom<br/> maisonettes and penthouses.
</p>`,
      location: "Ikoyi, Lagos State",
